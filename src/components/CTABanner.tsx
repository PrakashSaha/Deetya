...
export default function CTABanner() {
  ...
  return (
    <section id="cta" className="py-28 md:py-36 lg:py-44 relative ref-blue-bg" ref={ref}>
      ...
      <div className="section-container relative z-10">
        <div className="bg-linear-to-br from-indigo-600 to-purple-700 rounded-[3rem] p-12 md:p-20 lg:p-28 lg:pb-36 text-white relative overflow-hidden shadow-2xl shadow-indigo-500/40 fade-up flex flex-col items-center">
          ...
          <div className="max-w-4xl mx-auto relative z-10 w-full flex flex-col items-center text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 transition-all duration-300 w-full overflow-visible">
              <a href="mailto:contact@deetya.enterprise" className="flex items-center justify-center gap-4 bg-white text-indigo-700 font-black text-xl py-5 px-10 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-white/20 w-full sm:w-auto no-underline">
                <Mail size={24} /> Email Us
              </a>
              <a href="#" className="flex items-center justify-center gap-4 bg-indigo-500/20 text-white font-black text-xl py-5 px-10 rounded-full border-2 border-white/30 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:border-white w-full sm:w-auto no-underline">
